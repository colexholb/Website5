...
Added all the TODO Items. */

let phoneRegex = /^\d{10}$/;  //TODO go to regexer.com or reg101.com and find a suitable phone number regex and place here
...
function checkRequired(id, message) {
    ...
    switch (type) {
      ...
      case 'radio':
        ...
        let elements = document.querySelectorAll(`input[name="${el.name}"]:checked`);
